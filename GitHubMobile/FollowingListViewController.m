...
- (void)init:(UAGithubEngine *)githubEngine
{
    ...
    [self.githubEngine following:self.githubEngine.username];
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if([segue.identifier isEqualToString:@"userProfile"])
    {
        ...
        self.githubEngine = [[UAGithubEngine alloc] initWithUsername:name password:nil delegate:self withReachability:YES];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [self.following objectAtIndex:indexPath.row];
...
{
    NSLog(@"Received following for connection: %@, %@", connectionIdentifier, following);
