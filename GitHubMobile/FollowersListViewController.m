...
- (void)init:(UAGithubEngine *)githubEngine
{
    ...
    [self.githubEngine followers:self.githubEngine.username];
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        // the chosen UITableViewCell as sender.
        NSString * userName = [[sender textLabel] text];
        self.githubEngine = [[UAGithubEngine alloc] initWithUsername:userName password:nil delegate:self withReachability:YES];
...
{
    [self.followers objectAtIndex:indexPath.row];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [self.followers objectAtIndex:indexPath.row];
...
{
    NSLog(@"Received followers for connection: %@, %@", connectionIdentifier, followers);
